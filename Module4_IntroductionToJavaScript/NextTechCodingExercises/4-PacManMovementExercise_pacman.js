...
const pacArray = [
    ['/MITxPro/Module4-IntroductionToJavaScript/Pictures/PacMan1.png', '/MITxPro/Module4-IntroductionToJavaScript/Pictures/PacMan2.png'],
    ['/MITxPro/Module4-IntroductionToJavaScript/Pictures/PacMan3.png', '/MITxPro/Module4-IntroductionToJavaScript/Pictures/PacMan4.png'],
];
...
// TODO: Add a JavaScript setInterval() method that will call the Run() function above every 200 milliseconds. Note: in the video, Dr. Williams uses the setTimeout() method, but here we are going to use a slightly different method called setInterval(), so that you can have practice using this method.
setInterval(Run, 200);
